...
<template>
  <div class="license-page">
    <p class="license-back"><button @click="goBack" class="back-btn">&larr; {{ t('license.back') }}</button></p>
    <h2 class="license-title">{{ t('license.title') }}</h2>
    <hr class="license-divider">

    <h3 class="license-subtitle">{{ t('license.pclCeModTitle') }}</h3>
    <p class="license-meta">{{ t('license.copyright') }}</p>
    <p class="license-meta">{{ t('license.sourceLink') }}<a href="https://github.com/PCL-Community/PCL-CE" target="_blank" class="license-link">https://github.com/PCL-Community/PCL-CE</a></p>
    <p class="license-meta">{{ t('license.licenseType') }}</p>
    <p class="license-meta" style="margin-bottom:16px;">{{ t('license.usage') }}</p>
...
.license-back { margin: 0 0 12px 0; }
.back-btn {
  border: none;
  background: none;
  color: #00BCD4;
